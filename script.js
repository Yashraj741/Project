...
pdfFileInput.addEventListener('change', function () {
    ...
    if (file) {
        ...
        reader.onload = function (e) {
            ...
            img.style.width = '615px'; // Set the width to 615px
            img.style.height = '416px'; // Set the height to 416px
        ...
        reader.onload = function (e) {
            ...
            img.onload = function () {
                try {
                    ...
                    const imgWidth = 615; // Set the width to 615px
                    const imgHeight = 416; // Set the height to 416px
...
// Reset the application for PDF Converter
const pdfResetBtn = document.getElementById('pdfResetBtn');
pdfResetBtn.addEventListener('click', function () {
    pdfFileInput.value = "";
    pdfPreviewDiv.innerHTML = ""; // Clear the preview in the upload box
